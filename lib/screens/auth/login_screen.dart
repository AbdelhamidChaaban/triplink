...
class LoginScreen extends StatefulWidget { // Define LoginScreen widget
  const LoginScreen({super.key}); // Constructor for LoginScreen

  @override // Override createState method
  State<LoginScreen> createState() => _LoginScreenState(); // Create state for LoginScreen
} // End of LoginScreen class

class _LoginScreenState extends State<LoginScreen> { // Define LoginScreen state
  ...
  Future<void> _login() async { // Define login method
    ...
    try { // Start try block
      await _authService.signIn( // Call sign in method , authenticate with firebase
        email: _emailController.text.trim(), // -  (.trim()) to remove accidental spaces before/after email and password.
        password: _passwordController.text.trim(), // Trim password input
      ); // End of signIn call

      if (mounted) { // Check if widget is active
            ...
            child: Form( // Create form
              ...
              child: Column( // Create column layout
                ...
                children: [ // Start children list
                  ...
                  Text( // Create text
                    'Sign in to continue', // Sign in text
                  ...
                  ElevatedButton( // Create sign in button
                    ...
                    child: _isLoading // Check loading state
                        ...
                        : const Text('Sign In'), // Show sign in text
                  ), // End of ElevatedButton
                  const SizedBox(height: 16), // Add spacing
                  TextButton( // Create sign up button
                    onPressed: () { // Define onPressed
                      Navigator.of(context).push( // Navigate to new screen
                        MaterialPageRoute( // Create route
                          builder: (context) => const RegisterScreen(), // Navigate to register screen
                        ), // End of MaterialPageRoute
                      ); // End of push
                    }, // End of onPressed
                    child: const Text('Don\'t have an account? Sign Up'), // Button text
                  ), // End of TextButton
...
} // End of _LoginScreenState class 